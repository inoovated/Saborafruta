...
from .outras_movimentacoes import OutrasMovimentacoesHubView, DevolucaoClienteView, SaidaEspecialView
...
__all__ = [
    ...
    'AlertaListView',
    'SugestaoComprasView',
    'OutrasMovimentacoesHubView', 'DevolucaoClienteView', 'SaidaEspecialView',
]
