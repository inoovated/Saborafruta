...
<nfeProc xmlns="http://www.portalfiscal.inf.br/nfe">
  <NFe>
    ...
    def test_tela_custos_simula_e_aplica_icms_nao_recuperavel(self):
        ...
        self.assertContains(response, 'Custo anterior unit.')
        self.assertContains(response, 'Salvar e recalcular custo')
        self.assertNotContains(response, 'Diferenca contra total da nota')
    ...
    def test_conferencia_permite_receber_item_como_varios_produtos(self):
        ...
        self.assertContains(response_get, 'entrada-multi-badge is-configured')
        self.assertContains(response_get, 'data-multi-configured="1"')
        self.assertContains(response_get, 'data-multi-only-toggle')
        self.assertContains(response_get, 'Ver apenas varios produtos')
