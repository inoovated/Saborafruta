...
from apps.financeiro.views import plano_contas as plano_contas_views
...
urlpatterns = [
    ...
    path("plano-contas/novo/", plano_contas_views.PlanoContasCreateView.as_view(), name="plano_contas_criar"),
    path("plano-contas/<int:pk>/editar/", plano_contas_views.PlanoContasEditView.as_view(), name="plano_contas_editar"),
    path("plano-contas/<int:pk>/toggle-ativo/", plano_contas_views.PlanoContasToggleAtivoView.as_view(), name="plano_contas_toggle"),
