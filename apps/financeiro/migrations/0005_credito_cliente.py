...
class Migration(migrations.Migration):
    """
    Tabela financeiro_credito_cliente ja foi criada pelo ramo main em
    financeiro.0006_credito_cliente. Usamos SeparateDatabaseAndState para
    apenas registrar o estado no Django sem tocar no banco.
    """
