...
class Migration(migrations.Migration):
    """
    Tabela registros_auditoria e seus indices ja foram criados pelo ramo main
    em 0014_registroauditoria. Usamos SeparateDatabaseAndState para apenas
    registrar o estado no Django sem tocar no banco.
    """
