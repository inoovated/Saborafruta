...
class Migration(migrations.Migration):
    """
    Tabelas parametros_sistema e parametros_documento_fiscal ja foram criadas
    pelo ramo main (0012_parametros_sistema). Usamos SeparateDatabaseAndState
    para apenas registrar o estado no Django sem tocar no banco.
    """
